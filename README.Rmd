...
The list of environment variables consulted by functions in this package is:
...
Not everything here is required, some of these variables will have reasonable defaults.
